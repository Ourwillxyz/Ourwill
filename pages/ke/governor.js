...
const candidates = [
  { name: 'Hon. Esther Nyambura', color: '#001f3f', party: 'ODM', symbol: '🟧' },
  { name: 'Hon. Daniel Kipkoech', color: '#FFDC00', party: 'UDA', symbol: '🌽' },
  { name: 'Hon. James Mwenda', color: '#7FDBFF', party: 'KANU', symbol: '🦅' },
];

export default function GovernorPoll() {
