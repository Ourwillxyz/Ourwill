...
const candidates = [
  { name: 'Hon. Grace Wanjiru', color: '#F012BE', party: 'Wiper', symbol: '🌸' },
  { name: 'Hon. Betty Chebet', color: '#0074D9', party: 'UDA', symbol: '⭐' },
  { name: 'Hon. Fatma Salim', color: '#85144b', party: 'ODM', symbol: '🌹' },
];

export default function WomenRepPoll() {
