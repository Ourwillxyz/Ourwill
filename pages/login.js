...
export default function Login() {
  ...
  const handlePasswordReset = async (e) => {
    ...
    const { error } = await supabase.auth.resetPasswordForEmail(resetEmail, {
      redirectTo: 'https://ourwill.vercel.app/auth/callback', // Use your actual callback route
    });
    ...
    return (
      <div style={{
        ...
        <form onSubmit={handleProfileSubmit} style={{
          ...
          <input name="mobile" value={profile.mobile} onChange={handleProfileChange} placeholder="Mobile" required style={dropdownStyle} />
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <img src="/ourwill-logo.png" alt="OurWill Logo"
              style={{
                width: 80,
                height: 'auto',
                borderRadius: 12,
            ...
            <img src="/kenya-flag.jpg" alt="Kenya Flag"
              style={{
                width: 48,
                height: 32,
                borderRadius: 6,
          ...
          {!showReset ? (
            ...
            <form onSubmit={handlePasswordReset}>
              ...
              {resetMsg && (
                <div style={{
                  marginTop: 16,
                  color: resetMsg.startsWith('Password reset link sent') ? '#22c55e' : '#dc2626',
                  fontWeight: 500
                }}>
                  {resetMsg}
                </div>
